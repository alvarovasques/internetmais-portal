...
export default function Aplicativos() {
  ...
  const apps: AppWithPlan[] = [
    ...
    { name: 'PlayKids+', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/playkids_efc90861.png', type: 'standard', plans: ['400MB', '600MB', '800MB'] },
    { name: 'Sky+ Light SVA', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/sky_light_b88fcd47.png', type: 'standard', plans: ['400MB', '600MB', '800MB'] },
