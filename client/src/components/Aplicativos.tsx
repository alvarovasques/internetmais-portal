...
export default function Aplicativos() {
  ...
  const apps: AppWithPlan[] = [
    ...
    { name: 'Sky+ Light', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/sky_light_ee042781.png', type: 'standard', plans: ['400MB', '600MB', '800MB'] },
    ...
    { name: 'Revistaria', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/revistaria_57a18214.png', type: 'standard', plans: ['400MB', '600MB', '800MB'] },
    ...
    // Apps Premium
    { name: 'Smart Content', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/smart-content_3b2b586b.png', type: 'premium', plans: ['600MB', '800MB'] },
    ...
    { name: 'Queima Diária', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663028749933/QrZSp3M6QVWAMUgvwA5jWP/queima_diaria_632d2c4f.png', type: 'premium', plans: ['600MB', '800MB'] },
